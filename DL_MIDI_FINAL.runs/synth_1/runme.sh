...
HD_PWD='D:/Games/VIVADO_PROJECTS/DL_MIDI_FINAL/DL_MIDI_FINAL.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MIDI_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MIDI_top.tcl
