...
HD_PWD='D:/Games/VIVADO_PROJECTS/DL_MIDI_FINAL/DL_MIDI_FINAL.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MIDI_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MIDI_top.tcl -notrace
